  ...
  return (
    <main className="px-6 pb-20 pt-6 text-white lg:px-10">
      <div className="mx-auto w-full max-w-170 rounded-md border border-border-strong bg-surface p-4 sm:p-6">
        ...
        <h1 className="mt-5 text-center text-[28px] font-medium leading-10 tracking-[-0.01em] text-foreground">
        ...
        <section className="mt-5">
          <p className="text-foreground">Your Order</p>
          <div className="mt-4 space-y-4">
            {order.orderItems.map((item) => (
              <article
                key={item.id}
                className="flex gap-4 rounded-md border border-border-strong bg-surface-muted p-4"
              >
                ...
                <div className="flex min-w-0 flex-1 items-end justify-between gap-4">
                  <div>
                    ...
                    <span className="mt-2 inline-flex rounded-md bg-brand-strong px-3 py-1 text-xs font-medium text-accent-soft">
        ...
        <section className="mt-5 border-t border-border-default pt-5 text-sm text-foreground-soft">
          ...
          <div className="space-y-4 border-b border-border-default py-5">
            <p className="font-medium text-foreground">Transaction Fees</p>
            <div className="flex items-start justify-between gap-4">
          ...
          <div className="flex items-end justify-between gap-4 py-5">
            ...
            <span className="text-[36px] font-medium leading-10 tracking-[-0.01em] text-foreground">
